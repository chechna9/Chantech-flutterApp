...
class AffectRespo extends StatefulWidget {
  final int idChantier;
  AffectRespo({Key? key, required this.idChantier}) : super(key: key);

  @override
  _AffectRespoState createState() => _AffectRespoState();
}

class _AffectRespoState extends State<AffectRespo> {
